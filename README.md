...
```
  ...
  ![e1_r_before_injection](https://github.com/ManyFace/AndroidInjection/images/1/1.png "e1_r1_before_injection")
...
```
  ...
  ![e1_r_after_injection](https://github.com/ManyFace/AndroidInjection/images/1/4.png "e1_r1_after_injection")
...
* 注入点的确定
  ...
  ![e2_ida](https://github.com/ManyFace/AndroidInjection/images/2/4.png "e2_ida")
...
```
  ...
  ![e2_r_before_injection](https://github.com/ManyFace/AndroidInjection/images/2/1.png "e2_r_before_injection")
...
```
  ...
  ![e2_r_after_injection](https://github.com/ManyFace/AndroidInjection/images/2/3.png "e2_r_after_injection")
...
* 如何执行注入so中的初始化函数
  ...
  ![e3_init_array](https://github.com/ManyFace/AndroidInjection/images/3/1.png "e3_init_array")
* ARM状态切换
...
```
  ...
  ![e3_r_before_injection](https://github.com/ManyFace/AndroidInjection/images/3/2.png "e3_r_before_injection")
...
```
  ...
  ![e3_r_after_injection](https://github.com/ManyFace/AndroidInjection/images/3/3.png "e3_r_after_injection")
